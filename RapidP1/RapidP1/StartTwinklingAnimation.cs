...
namespace RapidP1
{
    ...
    public class Twinkle
    {
        ...
        public Twinkle(Texture2D spriteStrip, int x, int y)
        {
        ...
        /// <summary>
        /// Draws the explosion. This only has an effect if the twinkle animation is playing
        /// </summary>
        ...
        /// </summary>
        /// <param name="spriteStrip">the sprite strip for the twinkle</param>
        private void Initialize(Texture2D spriteStrip)
        {
            ...
            frameWidth = strip.Width / 2;
            frameHeight = strip.Height / 2;
        ...
        /// </summary>
        /// <param name="x">the x location of the center of the twinkle</param>
        /// <param name="y">the y location of the center of the twinkle</param>
        ...
        private void SetSourceRectangleLocation(int frameNumber)
        {
            ...
            sourceRectangle.X = (frameNumber % 2) * frameWidth;
            sourceRectangle.Y = (frameNumber / 2) * frameHeight;
        }
