...
namespace RapidP1
{
    ...
    public class SunAnimation
    {
        ...
        public SunAnimation(Texture2D spriteStrip, int x, int y, Color color)
        {
        ...
        private void Initialize(Texture2D spriteStrip)
        {
            ...
            frameWidth = strip.Width / 5;
            frameHeight = strip.Height / 5;
        ...
        private void SetSourceRectangleLocation(int frameNumber)
        {
            ...
            sourceRectangle.X = (frameNumber % 5) * frameWidth;
            sourceRectangle.Y = (frameNumber / 5) * frameHeight;
        }
